            ...
            <div class="col-lg-12">
                <div class="box">
                    <div class="box-header">
                        <a href="{{ route('admin.blog.tambah') }}" class="btn btn-primary">Tambah data</a>
                    </div>
                            ...
                            <tbody>
                                @foreach ($data as $key => $item)
                                    <tr>
                                        ...
                                        <td class="">
                                            <a href="{{ route('admin.blog.edit', $item->id) }}" type="button" class="btn btn-success "><i class="fa fa-edit"></i></a>
                                            <a 
                                            href="#modalDelete" 
                                            data-href="{{route('admin.blog.hapus', $item->id)}}"
                                            type="button" 
                                            data-toggle="modal"
